            ...
            {[
              ...
              },
             {
            ...
            },
              {
                ...
                description: "Custom mobile applications for iOS and Android platforms to enhance your business reach.",
                features: ["Native App Development", "Cross-Platform Solutions", "App Store Optimization", "Maintenance & Support"],
                highlight: "50+ apps launched",
              },
              {
                image: "/services/web-development.png",
                title: "Web Development",
                description: "Professional website development with modern technologies and responsive design.",
                features: ["Custom Websites", "E-commerce Solutions", "CMS Integration", "Performance Optimization"],
              ...
              },
              {
                ...
                features: ["User Research", "Wireframing", "Prototype Development", "Usability Testing"],
                highlight: "40% conversion increase",
              },
              {
                ...
                highlight: "Top 3 rankings achieved",
              },
              {
                image: "/services/logo-design-branding.jpg",
                title: "Logo Design & Branding",
                description: "Professional brand identity design that captures your business essence and values.",
                features: ["Logo Design", "Brand Guidelines", "Visual Identity", "Marketing Materials"],
                highlight: "200+ brands created",
              },
              {
                image: "/services/content-creation.jpeg",
                title: "Content Creation",
                description: "High-quality content development for websites, blogs, and marketing campaigns.",
                features: ["Blog Writing", "Website Copy", "Social Media Content", "Video Scripts"],
                highlight: "1M+ words written",
              },
              {
                image: "/services/meta-ads.jpeg",
                title: "Meta Ads (Facebook)",
                description: "Strategic Facebook and Meta advertising campaigns to reach your target audience effectively.",
                features: ["Campaign Setup", "Audience Targeting", "Ad Creative Design", "Performance Tracking"],
                highlight: "300% ROI average",
              },
              {
                image: "/services/instagram-ads.jpeg",
                title: "Instagram Ads",
                description: "Engaging Instagram advertising campaigns that drive brand awareness and conversions.",
                features: ["Story Ads", "Feed Advertising", "Influencer Partnerships", "Analytics & Insights"],
                highlight: "2M+ impressions monthly",
              },
              {
                image: "/services/graphic-design.avif",
                title: "Graphic Design Services",
                description: "Creative graphic design solutions for print and digital marketing materials.",
                features: ["Print Design", "Digital Graphics", "Infographics", "Presentation Design"],
                highlight: "500+ designs delivered",
              },
              {
                image: "/services/social-media-marketing.jpg",
                title: "Social Media Marketing",
                description: "Comprehensive social media strategies to build brand presence and engage customers.",
                features: ["Strategy Development", "Content Planning", "Community Management", "Paid Social Campaigns"],
                highlight: "150% follower growth",
              },
              {
